...
def graf_alkohol():
    ...
    plt.barh(podatki['drzava'], podatki['alkohol'], color="#FA8072")
...
def graf_voznja():
    plt.figure(figsize=(10, 6))
    plt.barh(podatki['drzava'], podatki['voznja'], color="#87CEEB")
...
def graf_pasu():
    plt.figure(figsize=(10, 6))
    plt.barh(podatki['drzava'], podatki['pas'], color="#90EE90")
...
def graf_telefon():
    plt.figure(figsize=(10, 6))
    plt.barh(podatki['drzava'], podatki['telefon'], color="#FFB6C1")
